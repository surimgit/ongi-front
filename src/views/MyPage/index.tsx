...
import {
  ACCESS_TOKEN,
  MY_ACTIVITY_ABSOLUTE_PATH,
  MYPAGE_ACCOUNT_ABSOLUTE_PATH,
} from "src/constants";
...
import {
  addBadgeRequest,
  addLikeKeywordRequest,
  chooseBadgeRequest,
  deleteLikeKeywordRequest,
  fileUploadRequest,
  getBadgeListRequest,
  getUserIntroductionRequest,
...
} from "src/apis/dto/request/user";
...
export default function MyPage() {
  ...
  const updateButtonClass = isEditMode
    ? isActive
      ? "correction active"
      : "correction disable"
    : "correction";
  ...
  const deleteLikeKeywordResponse = (
    responseBody: ResponseDto | null,
    keyword: string
  ) => {
    const message = !responseBody
  ...
  const onDeleteKeywordClickHandler = async (keyword: string) => {
    ...
    deleteLikeKeywordRequest(requestBody, accessToken).then((res) =>
      deleteLikeKeywordResponse(res, keyword)
    );
  };
  ...
  const getBadgeListResponse = (
    responseBody: GetBadgeListResponseDto | ResponseDto | null
  ) => {
    const message = !responseBody
      ? "서버에 문제가 있습니다."
      : responseBody.code === "DBE"
  ...
  const getUserIntroductionResponse = (
    responseBody: GetUserIntroductionResponseDto | ResponseDto | null
  ) => {
    const message = !responseBody
      ? "서버에 문제가 있습니다."
      : responseBody.code === "DBE"
    ...
    const {
      ...
      likeKeywords,
      userPoint,
    } = responseBody as GetUserIntroductionResponseDto;
  ...
  const onSelfIntroductionChangeHandler = (
  ...
  const onEditButtonClickHandler = async () => {
    ...
    patchUserIntroductionRequest(requestBody, accessToken).then(
    ...
    <div id="mypage-main-wrapper">
      ...
      <div className="contents-wrapper">
        ...
        <div className="correction-area">
          <div className={updateButtonClass} onClick={onEditButtonClickHandler}>
            {buttonText}
          </div>
          <div className="bridge">|</div>
          <div className="correction" onClick={onAccountButtonClickHandler}>
            계정 설정
          </div>
        </div>
        <div className="body">
                ...
                {isEditMode ? (
                  <>
                    ...
                    <div
                      ...
                      onClick={onProfileImageDeleteHandler}
                    ></div>
                    <input
                      ref={fileRef}
                      style={{ display: "none" }}
          ...
          <div className="user-info-area">
            <div className="outline">
              ...
              <div className="achievements-box">
                ...
                <div
                  className="button-change-achievements"
                  onClick={onBadgeModalOpenButtonClickHanlder}
                />
                {isBadgeModalOpen && (
                  <Modal
                    title="뱃지를 선택하세요!!"
            ...
            <div className="detail">
              ...
              <div className="specialty-box">
                <div className="tag-button-wrapper">
                  <div
                    className="tag-button plus"
                    onClick={onModalOpenButtonClickHandler}
                  ></div>
                  {isModalOpen && (
                    <Modal
                      title="키워드를 추가해보세요!"
                    ...
                    >
                      ...
                      <div className="modal-input-wrapper">
                        ...
                        <div
                          ...
                          onClick={onSelectKeywordClickHandler}
                        >
                          선택
                        </div>
                      </div>
                      <div className="modal-keywords-wrapper">
                        {addedKeywords.map((index, key) => (
                          <div className="modal-keyword-items">{index}</div>
                        ))}
                      </div>
                      <div
                        className="modal-add-button"
                        onClick={onAddKeywordClickHandler}
                      >
                        추가
                      </div>
                    </Modal>
            ...
            {isEditMode ? (
              <div className="textarea-wrapper">
                ...
                <div className="char-count">
                  {selfIntro ? selfIntro.length : 0} / 250
                </div>
              </div>
            ) : (
