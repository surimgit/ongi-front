  ...
  return (
    <div id='mypage-main-wrapper'>
      ...
      <div className='contents-container'>
        <div className='titie-area'>
          <div className='title'>마이페이지</div>
          <div className='current'>내 정보</div>
        ...
        <div className='body'>
          ...
          <div className='user-info-area'>
            <div className='outline'>
              ...
              <div className='badge-box'>
                ...
                <div className='badge-image'>ㅇ</div>
              </div>
              <div className='achievements-box'>
                <div className='text'>업적</div>
                <div className='select'>자기소개 작성 완료</div>
          ...
          <div className='introduce-box'>
            ...
            <div className='introduce-datial'>재산권의 행사는 공공복리에 적합하도록 하여야 한다. 국채를 모집하거나 예산외에 국가의 부담이 될 계약을 체결하려 할 때에는 정부는 미리 국회의 의결을 얻어야 한다. 대통령의 국법상 행위는 문서로써 하며, 이 문서에는 국무총리와 관계 국무위원이 부서한다. 군사에 관한 것도 또한 같다. 국가는 주택개발정책등을 통하여 모든 국민이 쾌적한 주거생활을 할 수 있도록</div>
          </div>
        </div>
      </div>
