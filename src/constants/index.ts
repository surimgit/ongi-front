...
export const CHAT_VIEW_PATH = "view";
...
export const COMMUNITY_PAGE_ABSOLUTE_URL = (boardType: Board, page: number) =>
  `${COMMUNITY_BOARD_ABSOLUTE_PATH(boardType)}&page=${page}`;
export const COMMUNITY_BOARD_ABSOLUTE_PATH = (boardType: Board) =>
  `${ROOT_PATH}${COMMUNITY_PATH}?board=${boardType}`;
export const COMMUNITY_CATEGORY_ABSOLUTE_PATH = (
  boardType: Board,
  category: CommunityCategory
) => `${COMMUNITY_BOARD_ABSOLUTE_PATH(boardType)}&category=${category}`;
...
export const COMMUNITY_VIEW_ABSOLUTE_PATH = (postSequence: number | string) =>
  `${ROOT_PATH}${COMMUNITY_PATH}/${postSequence}`;
export const COMMUNITY_EDIT_ABSOLUTE_PATH = (postSequence: number | string) =>
  `${ROOT_PATH}${COMMUNITY_PATH}/${postSequence}/${COMMUNITY_EDIT_PATH}`;
export const COMMUNITY_SEARCH_ABSOLUTE_PATH = (
  searchCategory: SearchCategory,
  keyword: string
) =>
  `${ROOT_PATH}${COMMUNITY_PATH}/search?type=${searchCategory}&keyword=${keyword}`;

export const COMMUNITY_INFOBOARD_ABSOLUTE_PATH = `${ROOT_PATH}${COMMUNITY_PATH}/${COMMUNITY_INFOBOARD_PATH}`;
export const COMMUNITY_HOTBOARD_ABSOLUTE_PATH = (boardType: Board) =>
  `${ROOT_PATH}${COMMUNITY_PATH}?board=${boardType}`;
...
export const OTHER_MYPAGE_VIEW_ABSOULTE_PATH = (userId: string) =>
  `${ROOT_PATH}${OTHER_MYPAGE_PATH}?userId=${userId}`;
...
export const QUESTION_PATCH_ABSOLUTE_PATH = (
  questionSequence: number | string
) =>
  `${ROOT_PATH}${MYPAGE_PATH}/${QUESTION_PATH}/${questionSequence}/${QUESTION_PATCH_PATH}`;
export const QUESTION_VIEW_ABSOLUTE_PATH = (
  questionSequence: number | string
) => `${ROOT_PATH}${MYPAGE_PATH}/${QUESTION_PATH}/${questionSequence}`;
export const QUESTION_ANSWER_ABSOLUTE_PATH = (
  questionSequence: number | string
) => `${ROOT_PATH}${MYPAGE_PATH}/${QUESTION_PATH}/${questionSequence}`;
...
export const NOTICE_PATCH_ABSOLUTE_PATH = (sequence: number | string) =>
  `${ROOT_PATH}${MYPAGE_PATH}/${NOTICE_PATH}/${sequence}/${NOTICE_PATCH_PATH}`;
export const NOTICE_VIEW_ABSOLUTE_PATH = (sequence: number | string) =>
  `${ROOT_PATH}${MYPAGE_PATH}/${NOTICE_PATH}/${sequence}`;
...
export const NEEDHELPER_VIEW_ABSOLUTE_PATH = (postSequence: number | string) =>
  `${ROOT_PATH}${NEEDHELPER_PATH}/${postSequence}`;

export const CHAT_ABSOLUTE_PATH = `${ROOT_PATH}${CHAT_PATH}`;
export const CHAT_VIEW_ABSOLUTE_PATH = `${ROOT_PATH}${CHAT_PATH}/${CHAT_VIEW_PATH}`;

export const CALENDAR_ABSOLUTE_PATH = `${ROOT_PATH}${CALENDAR_PATH}`;
export const POLICY_ABSOLUTE_PATH = (
  plcyNo: string,
  plcyNm: string,
  keyword?: string,
  regions?: string,
  ...
  return `/${POLICY_PATH}?${queryString}`;
};
